...
def common_args():
    ...
    parser.add_argument('--state_shape', type=int, default=12, help='random seed')
    return parser
...
def train_args(parser):
    ...
    parser.add_argument('--heal_init', type=float, default=1.0, help='Initial health info.')
    return parser
...
def evaluate_args(parser):
    ...
    parser.add_argument('--evaluate_epoch', help='used for degree evaluation: evaluate #evaluate_epoch*#task_size '
                                                 'episodes, performance is calculated every #task_size episodes and '
                                                 'generate #evaluate_epoch results', type=int, default=20)
    parser.add_argument('--heal_init', type=float, default=1.0, help='Initial health info.')
