...
class Trainer:
    ...
    def evaluate_total(self, last=True):
        args = self.args
    ...
    def plt(self):
        ...
        y_name = ['Rewards', '$T_{latest}$', 'Constrains', '$success\_{rate}$', 'run time']
...
if __name__ == '__main__':
    ...
    env = ENV(args.width, args.length, args.drop_num,
                  n_blocks=args.block_num, fov=args.fov, stall=args.stall, isTrain=True, heal_init=args.heal_init)
