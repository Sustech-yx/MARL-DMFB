...
from common.arguments import common_args, evaluate_args, set_default
from env.DMFB.dmfb import DMFBenv, DMFBenv_v0_1
import yaml
import os
...
def run():
    ...
    # ----一次运行FF
    env = DMFBenv_v0_1(args.width, args.length, args.drop_num,
